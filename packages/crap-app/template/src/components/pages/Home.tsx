...
export default function Home() {
    ...
    return (
        <>
            <Img src={imgSrc} />
            <p>
                This version brought to you by Christmas dog.{' '}
                <ExternalLink href="https://pixabay.com/photos/dog-puppy-pet-animals-christmas-2617517/">
                    Image
                </ExternalLink>{' '}
                by{' '}
                <ExternalLink href="https://pixabay.com/users/stocksnap-894430/">
                    StockSnap
                </ExternalLink>
                .
            </p>
            ...
            {showDialog && (
                <BodyEnd>
                    <CorgiDialog close={() => setShowDialog(false)} />
                </BodyEnd>
            )}
        </>
    )
