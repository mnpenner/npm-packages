...
```sh
bun "packages/routekit/gen-api-client.ts" "packages/routekit/src/examples/router-instance.ts" "experimental/url-pattern/dist/api-client.gen.ts" --client-name CustomApiClient --import-type CustomPromise:./api.ts --response-type CustomPromise
```
