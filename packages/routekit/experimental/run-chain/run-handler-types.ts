...
export type RequestMiddleware<Ctx extends object = AnyContext> = ChainableFn<
    RequestContext<Ctx>,
    any,
    any,
    any
...
export type RequestHandler<Ctx extends object = AnyContext> = TerminalFn<
    RequestContext<Ctx>,
    Response
>
...
export type AnyMiddleware<Ctx extends object = AnyContext> = MaybeArray<
    RequestMiddleware<Ctx> | Falsy
>
...
export type RequestSideEffect<Ctx extends object = AnyContext> = ChainableFn<
    RequestContext<Ctx>,
    any,
    any,
    void
