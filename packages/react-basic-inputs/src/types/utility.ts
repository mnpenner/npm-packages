...
export type Override<Base, Extension, DeleteKeys extends PropertyKey = never> = Omit<
    Base,
    keyof Extension | DeleteKeys
> &
    Extension
export type PartiallyRequired<Type, Key extends keyof Type> = Omit<Type, Key> &
