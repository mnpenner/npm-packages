...
const FlexRow: FC<{ children: ReactNode }> = ({ children }) => (
...
function Select_Example2() {
    ...
    return (
        <>
            ...
            <div className={css.flexRow}>
                <button type="button" onClick={() => setValue(null as any)}>
                    Set Null
                </button>
                <button type="button" onClick={() => setValue(2)}>
                    Set Cherry
                </button>
                <button type="button" onClick={() => setValue(FRUIT_OPTIONS.length + 1)}>
                    Set Invalid
                </button>
                <button type="button" onClick={() => setValue(Math.floor(Math.random() * 20))}>
                    Set Random
                </button>
...
function OtherTextInputsFieldset() {
    return (
        <FieldSet legend="Other Text Inputs">
            ...
            <label className={css.flexRow}>
                Number: <NumberInput placeholder={123} />
            </label>
            <label className={css.flexRow}>
                Decimal: <DecimalInput placeholder="456" />
            </label>
            <label className={css.flexRow}>
                Numeric: <NumericInput placeholder="3.14" />
            </label>
            <label className={css.flexRow}>
                Phone: <PhoneInput placeholder="867-5309" />
            </label>
            <label className={css.flexRow}>
                Search: <SearchInput placeholder="Google" />
            </label>
            <label className={css.flexRow}>
                Url: <UrlInput placeholder="example.org" />
            </label>
        </FieldSet>
    )
}
...
const ControlledDatetimeOffsetInput: FC<{ defaultValue: DateValue | (() => DateValue) }> = ({
    defaultValue,
}) => {
