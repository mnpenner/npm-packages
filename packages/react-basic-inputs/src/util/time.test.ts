...
describe(toIsoDateString.name, () => {
    ...
    it('default options', () => {
        ...
        expect(toIsoDateString('2024-09-01T18:28:00.001', { milliseconds: false })).toBe(
            '2024-09-01T18:28',
        ) // hide both
    ...
    it('with offset', () => {
        ...
        expect(toIsoDateString('2024-09-01T18:28:29.01', opts)).toBe(
            '2024-09-01T18:28:29.010-07:00',
        )
        expect(toIsoDateString('2024-09-01T18:28:29.001', opts)).toBe(
            '2024-09-01T18:28:29.001-07:00',
        )
        expect(toIsoDateString('2024-09-01T18:28:29.001Z', opts)).toBe(
            '2024-09-01T11:28:29.001-07:00',
        ) // converts to
        // local TZ
        expect(toIsoDateString(1725215281234, opts)).toBe('2024-09-01T11:28:01.234-07:00')
        expect(toIsoDateString(new Date(1999, 1, 2, 3, 4, 5, 6), opts)).toBe(
            '1999-02-02T03:04:05.006-08:00',
        )
    })
