...
// $ bun packages/server-router/src/bin/gen-api-client.ts "packages/server-router/example3/router.ts" -w
...
export type PostWidgetsByIdResponse = PostWidgetsByIdResponsesByStatus[keyof PostWidgetsByIdResponsesByStatus]
...
class ApiClient_Widgets_ById {
    constructor(private readonly fetcher: Fetcher) {}
    post(path: PostWidgetsByIdPathParams | SinglePathParam<PostWidgetsByIdPathParams, "id">, query: PostWidgetsByIdQuery, body: PostWidgetsByIdRequest) {
