 ...
 */
export type AddContext<Ctx extends object, In extends object = any> = ChainableFn<
    In & Partial<Ctx>,
    In & Ctx,
    any,
    any
...
export type TerminalFn<In = any, Out = any> = (ctx: In) => MaybePromise<Out>
export type RunChain<In = any, FinalOut = any> =
    | [
          ChainableFn<In, any, any, any>,
          ...ChainableFn<any, any, any, any>[],
          TerminalFn<any, FinalOut>,
      ]
