...
type CommandBuilder = Command & {
    ...
    arguments(items: readonly ArgumentSpec[]): Command
}
...
const configCommand = new Command('config')
    ...
    .commands([
        passthroughLeaf('current-context', 'Display the current-context'),
        passthroughLeaf('delete-cluster', 'Delete the specified cluster from the kubeconfig'),
        passthroughLeaf('delete-context', 'Delete the specified context from the kubeconfig'),
        passthroughLeaf('delete-user', 'Delete the specified user from the kubeconfig'),
        passthroughLeaf('get-clusters', 'Display clusters defined in the kubeconfig'),
        leaf({
            name: 'get-contexts',
        ...
        passthroughLeaf('get-users', 'Display users defined in the kubeconfig'),
        passthroughLeaf('rename-context', 'Rename a context from the kubeconfig file'),
        passthroughLeaf('set', 'Set an individual value in a kubeconfig file'),
        passthroughLeaf('set-cluster', 'Set a cluster entry in kubeconfig'),
        passthroughLeaf('set-context', 'Set a context entry in kubeconfig'),
...
const app = new App('Kubernetes Control')
    ...
    .commands([
        ...
        configCommand,
        passthroughLeaf('convert.exe', 'The command convert.exe is a plugin installed by the user'),
    ])
