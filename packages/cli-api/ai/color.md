...
We can probably implement this by attacking a _chalk instance to App and setting `level` appropriately based on `supportsColor` when --color=auto, or set level to 0 when --color=never.
