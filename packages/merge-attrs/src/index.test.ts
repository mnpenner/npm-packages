...
describe(mergeAttrs.name, () => {
    ...
    it('merges class names', () => {
        expect(mergeAttrs({ className: 'foo' }, { className: 'bar' })).toEqual({
            className: 'foo bar',
        })
        ...
        ).toEqual({ className: 'foo bar baz quux' })

        expect(mergeAttrs({ className: { foo: true, bar: false, baz: undefined } })).toEqual({
            className: 'foo',
        })

        expect(mergeAttrs({ className: undefined }, { className: ['foo', 'bar'] })).toEqual({
            className: 'foo bar',
        })
    })
