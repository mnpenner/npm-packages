...
it('quotes keyword property names', () => {
    expect(jsSerialize({class:1,do:2,finally:3,for:4,five:5})).to.equal(`{"class":1,"do":2,"finally":3,"for":4,five:5}`);
    expect(jsSerialize({class:1,do:2,finally:3,for:4,five:5},{safe:false})).to.equal(`{class:1,do:2,finally:3,for:4,five:5}`);
});
...
it('serializes functions', () => {
    ...
    expect(jsSerialize(function(x,y) { return x + y })).to.equal("function(x,y) { return x + y }");
    expect(jsSerialize(function mult(x,y) { return x * y; })).to.equal("function mult(x,y) { return x * y; }");
});
...
it('serializes recursive objects', () => {
    ...
    expect(jsSerialize({a:o,b:[o,1,o],c:{d:o,e:o,f:new Set([o])}},{safe:false})).to.equal('(o=>{o={a:{a:"perfect"},b:[,1,,],c:{f:new Set((o=>{o=[{a:"perfect"}];o[0].circle=o[0];return o})())}};o.a.circle=o.a;o.b[0]=o.a;o.b[2]=o.a;o.c.d=o.a;o.c.e=o.a;return o})()'); // FIXME: the object inside the set isn't === to the object outside the set -- there are *two* copies here
