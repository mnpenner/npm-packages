...
| `Result.fromThrowable(…)`                           | `nj(…)`                                     | Wrap thrown errors (neverject returns AsyncResult)                                              |
...
| `ResultAsync.fromThrowable(…)`                      | `nj(…)`                                     | Wrap thrown errors into AsyncResult                                                             |
...
| `fromThrowable(…)`                                  | `nj(…)`                                     | Top-level helper covered by `nj`                                                                |
| `fromAsyncThrowable(…)`                             | `nj(…)`                                     | Top-level helper covered by `nj`                                                                |
