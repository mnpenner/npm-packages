...
export type AllOkErrors<T extends readonly unknown[]> =
 ...
 */
export function allSettled<T extends readonly (NeverjectPromise<any, any> | MaybePromise<any>)[]>(
    inputs: T,
 ...
 */
export function allSettledRecord<
    T extends Record<string, NeverjectPromise<any, any> | MaybePromise<any>>,
>(inputs: T): NeverjectPromise<AllSettledRecord<T>, never> {
 ...
 */
export function allOk<T extends readonly (NeverjectPromise<any, any> | MaybePromise<any>)[]>(
    inputs: T,
 ...
 */
export function allOkRecord<
    T extends Record<string, NeverjectPromise<any, any> | MaybePromise<any>>,
>(inputs: T): NeverjectPromise<AllOkRecord<T>, AllOkRecordErrors<T>> {
    const entries = Object.entries(inputs)
